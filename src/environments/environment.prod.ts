...
export const environment = {
  ...
  sistema: 47,
  url_seguridad: "http://10.0.10.218:3009/api/v1/",
  loginUrlAsus: 'https://test.asuss.gob.bo/asuss-asegurado-api/api/v1/login',
  consultaUrlAsus: 'https://test.asuss.gob.bo/asuss-asegurado-api/api/v2/interoperabilidad/segip/consultaDatosPersona',
  userNameAsus: 'cbes',
